pipeline {
  ...
  environment {
    DOCKER_REGISTRY = 'shivamsankrit' // change this if your Docker Hub username is different
  ...
  stages {
    ...
    stage('Checkout Source') {
      steps {
        git url: 'https://github.com/Shivamsankrit/multi-container-node.git', branch: 'main'
      }
    }
